...
{
    use HasFactory, Notifiable, InteractsWithMedia, HasRoles, Impersonate, BelongsToTenant, Multitenantable, HasApiTokens;
    ...
    const FLAG = [
        ...
        'vi' => 'assets/img/LanguageImage/vietnam.png',
    ...
    public static $rules = [
        ...
        'email' => 'email:filter|max:191|unique:users,email,',
    ];
