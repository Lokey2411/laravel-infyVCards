...
Route::middleware('auth', 'valid.user')->group(function () {
    ...
    Route::prefix('sadmin')->middleware('role:super_admin')->group(function () {
        ...
        // Setting routes
        //        contact us
        Route::get('contact-us', [HomeController::class, 'showContactUs'])->name('contact.contactus');
        Route::delete('contact-us/{enquiry}',[HomeController::class, 'destroyContactUs'])->name('contactus.destroy');
