        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section px-3 mb-5">
                        <div class="section-heading px-3">
                            <h2 class="mb-5">{{ __('messages.plan.products') }}</h2>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section mb-5 px-3">
                        <div class="section-heading px-3">
                            <h2 class="mb-5">{{ __('messages.plan.testimonials') }}</h2>
                        </div>
                ...
                @if (checkFeature('instagramEmbed') && $vcard->instagramEmbed->count())
                    <div class="">
                        <div class="section-heading px-3 ms-3">
                            <h2 class="mb-5">{{ __('messages.feature.insta_embed') }}</h2>
                        </div>
                        <nav>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section mt-5 mb-2 px-3">
                        <div class="section-heading px-3">
                            <h2 class="mb-5">{{ __('messages.feature.blog') }}</h2>
                        </div>
            ...
            @endif
            {{-- made by --}}
            <div class="d-flex justify-content-evenly position-relative z-index-2">
