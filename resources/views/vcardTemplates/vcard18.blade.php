        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
                ...
                <div class="card flex-sm-row-reverse align-items-center pt-sm-0 pt-4">
                    <div class="card-img d-flex justify-content-center align-items-center">
                        <img src="{{ $vcard->profile_url }}"
                            class="w-100 h-100 rounded-circle object-fit-cover mb-5" />
                    </div>
                                        ...
                                        <div class="card-body text-center p-0">
                                            ...
                                            <div class="d-flex">
                                                <div class="quote-img quote-left-img">
                                                    <img
                                                        src="{{ asset('assets/img/vcard18/quote-left-img.png') }}" />
                                                </div>
                                                <p
                                                ...
                                                <div class="quote-img quote-right-img align-self-end">
                                                    <img
                                                        src="{{ asset('assets/img/vcard18/quote-right-img.png') }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-img">
                                            <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                                                <img src="{{ $blog->blog_icon }}"
                                                    class="img-fluid h-100 w-100 object-fit-cover mx-auto"></a>
                                        </div>
                                        <div class="card-body text-sm-start text-center bg-white">
                                            <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                                                <h2
                                                    class="mt-3 p-3 text-center fs-6 fw-5 text-black mb-1 blog-head text-black">
                                                    {{ $blog->title }}
                                                </h2>
                                            </a>
                                        </div>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section pt-60 px-sm-4 px-1 mb-40">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 pt-60 px-sm-4 px-1 mb-40">
            ...
            <div class="contact-us-section">
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    <div class="section-heading text-end overflow-hidden mb-40 px-4">
