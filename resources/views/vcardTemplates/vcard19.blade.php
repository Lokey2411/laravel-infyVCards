        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-40 px-40">
                        ...
                        <div class="">
                            ...
                            <div class="text-center me-5 mt-4">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section px-40 pt-40">
                        <div class="section-heading text-center mb-40">
                                        ...
                                        <div class="service-card h-100">
                                            <div
                                                ...
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    ...
                                                    <img src="{{ $service->service_icon }}" class="w-100" />
                                                </a>
                                            </div>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-40 px-40">
            ...
            @if (checkFeature('iframes') && $vcard->iframes->count())
                <div class="blog-section pt-40 pb-40 mt-5  my-0 p-0">
                    <div class="blog-bg-img1">
                        <img src="{{ asset('assets/img/vcard19/blog-bg-img1.png') }}" />
                    </div>
                    <div class="blog-bg-img2">
            ...
            @if (!empty($userSetting['enable_affiliation']))
                <div class="create-vcard-section my-5 px-40">
                    <div class="section-heading text-center mb-40">
