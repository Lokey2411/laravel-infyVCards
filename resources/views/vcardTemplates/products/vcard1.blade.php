...
<body class="h-auto">
   <div class="container p-0 h-100">
        <div class="vcard-one main-content  w-100 mx-auto content-blur allSection collapse show h-100">
                                ...
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card px-2 border-0 w-75 w-sm-100 h-100 mx-auto">
                                        <div class="product-profile d-flex justify-content-center">
                                            <img src="{{ $product->product_icon }}" alt="profile" class="w-50 text-center mt-5" height="208px"/>
                                        </div>
                                        <div class="mt-3">
                                            <h4>{{ $product->name }}</h4>
